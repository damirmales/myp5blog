    ...
    <article>
        <div class="container">
            ...
            <div class="row">
              ...
              <a href="#"><?php echo htmlspecialchars($article->getAuteur()) ?></a>
              <br>
            Le <?php echo htmlspecialchars($article->getDate_creation()) ?></span>
                    </div>
                    <p>Contenu : </p>
                    <p><?php echo htmlspecialchars($article->getContenu()) ?><!-- $article-> -->
                    <p><a href="index.php?route=deleteArticle&id=<?php echo htmlspecialchars($article->getArticles_id()) ?>"
                          onclick="return window.confirm(`Êtes vous sur de vouloir supprimer cet article ?!`)">Supprimer</a>
                    </p>
                    <p><a href="index.php?route=editArticle&id=<?php echo htmlspecialchars($article->getArticles_id()) ?>">
                            Modifier</a></p>
